...
public class TranslationUpdatedManagerTest {
    ...
    public void setup() {
        ...
        manager.init(translationStateCache, textFlowDAO,
                documentStatisticUpdatedEventEvent, webhookJmsEventEvent,
                documentDAO, personDAO,
    ...
    public void onTranslationUpdateTest() {
        ...
        verify(webhookJmsEventEvent)
                .fire(new WebhookJmsEvent(Lists.newArrayList(
                        new WebhookJms(webhookEvent, urlSecretMap))));
    }
}
